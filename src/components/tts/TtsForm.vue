        ...
        <CardContent class="pt-4">
            <form @submit.prevent="handleSubmit" class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <textarea id="text" v-model="text" :maxlength="TEXT_MAX_LENGTH" rows="5"
                        placeholder="Type your text here..." aria-label="Text"
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <select id="voice" v-model="voice" aria-label="Voice"
                ...
                <label class="flex items-center gap-2 text-sm text-muted-foreground cursor-pointer select-none">
                    <input type="checkbox" v-model="clearText" aria-label="Clear text after submitting"
